locals {
  ...
  runtime_secret_names = {
    ...
    jev_model            = "SCHEMASPRINT_JEV_MODEL"
    jev_timeout_seconds  = "SCHEMASPRINT_JEV_TIMEOUT_SECONDS"
    jev_max_retries      = "SCHEMASPRINT_JEV_MAX_RETRIES"
    llm_mode             = "SCHEMASPRINT_LLM_MODE"
    groq_api_url         = "SCHEMASPRINT_GROQ_API_URL"
    groq_api_key         = "SCHEMASPRINT_GROQ_API_KEY"
    groq_model           = "SCHEMASPRINT_GROQ_MODEL"
    groq_timeout_seconds = "SCHEMASPRINT_GROQ_TIMEOUT_SECONDS"
  }
}
